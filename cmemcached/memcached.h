...
// jinho added... follow this define
#define HYPERVISOR_MEMCACHED
...
enum conn_states {
    ...
    conn_push_hype,  /**< push data to hypervisor */
    conn_pop_hype,   /**< pop data from hypervisor */
...
struct conn {
    ...
    void    *hyperbuf;  /* should be freed after the get message transmitted */
#endif
